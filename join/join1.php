...
<body>
    ...
    <main id="main" role="main" class="mb100">
        <div class="container">
            <div class="intro__inner join line-bot">
                ...
                <h2>회원가입</h2>
                <p>
                    안녕하세요! 블로그를 이용하시기 전에<br>
                    본 <em>이용약관</em> 및 <em>개인정보 취급방침</em>을 주의 깊게 살펴보시기를 권장합니다.
                </p>
            </div>
            <!-- //intro__inner -->
            ...
            <div class="member__inner">
                ...
                <div class="member__policy">
                    <div class="agree">
                        <div class="scroll">1. 서론
                            1.1 이 이용약관은 [웹스로퍼](블로그)를 이용하는 모든 사용자(이하 "사용자" 또는 "회원")에게 적용됩니다.
                            이용약관을 읽고 이해하신 후, 본 블로그를 이용하시기 전에 본 이용약관을 주의 깊게 살펴보시기를 권장합니다.
                    ...
                    <div class="agree">
                        <div class="scroll">1. 개인 정보 수집
                            1.1 본 블로그는 회원 가입 및 콘텐츠 작성을 위해 필요한 개인 정보를 수집할 수 있습니다. 수집되는 정보는 다음과 같을 수 있습니다:
                            - 이름, 이메일 주소, 프로필 사진, 기타 선택적 정보

                            1.2 개인 정보는 회원의 동의 하에 수집되며, 회원은 언제든지 개인 정보를 제공하지 않을 권리가 있습니다.
                            그러나 일부 정보는 블로그를 이용하기 위해 필요할 수 있습니다.
                            ...
                            5. 쿠키와 추적 기술
                            5.1 블로그는 쿠키와 유사한 기술을 사용하여 사용자의 활동을 추적하고 분석하는 목적으로 정보를 수집할 수 있습니다.
                            이 정보는 사용자 경험을 향상시키기 위해 사용됩니다.

                            6. 개인 정보 열람 및 수정
                            6.1 회원은 언제든지 자신의 개인 정보를 열람하고 수정할 권리가 있습니다.
                            개인 정보 열람 및 수정은 회원의 프로필 설정을 통해 가능합니다.

                            7. 개인 정보 보유 기간
                            7.1 블로그는 회원의 개인 정보를 더 이상 필요하지 않은 경우에만 보관하며, 법률적인 의무 또는 다른 합법적인 이유로 인해 정보를 보관할 수 있습니다.

                            8. 연락처 정보
                            8.1 본 블로그와 관련된 개인 정보 취급 방침과 관련된 문의 사항은 다음 연락처를 통해 문의할 수 있습니다:</div>
                        <div class="check">
                    ...
                    <div class="center">
                        <a href="join2.php" class="btn-style" id="agreeBtn">동의하기</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        document.getElementById("agreeBtn").addEventListener("click", (e) => {
            e.preventDefault();
            ...
            if(agreeCheck1.checked && agreeCheck2.checked){
                alert("이용약관 및 개인정보에 동의하셨습니다. 감사합니다.🥰");
                window.location.href = "join2.php";
            } else {
                alert("이용약관 및 개인정보에 동의하셔야 합니다.");
            }
        });
    </script>
</body>
